...
function printResults1(data) {
  ...
  tempForecastEl.innerHTML =
    "<strong>Temp:</strong> " + data.list[8].main.temp + " °C";
  ...
  day2El.textContent =
    data.list[16].dt_txt + " " + data.list[16].weather[0].icon;
  var tempForecastEl2 = document.createElement("p");
  tempForecastEl2.innerHTML =
    "<strong>Temp:</strong> " + data.list[16].main.temp + " °C";
  ...
  day3El.textContent =
    data.list[24].dt_txt + " " + data.list[24].weather[0].icon;
  var tempForecastEl3 = document.createElement("p");
  tempForecastEl3.innerHTML =
    "<strong>Temp:</strong> " + data.list[24].main.temp + " °C";
  ...
  day4El.textContent =
    data.list[32].dt_txt + " " + data.list[32].weather[0].icon;
  var tempForecastEl4 = document.createElement("p");
  tempForecastEl4.innerHTML =
    "<strong>Temp:</strong> " + data.list[32].main.temp + " °C";
  ...
  day5El.textContent =
    data.list[39].dt_txt + " " + data.list[39].weather[0].icon;
  var tempForecastEl5 = document.createElement("p");
  tempForecastEl5.innerHTML =
    "<strong>Temp:</strong> " + data.list[39].main.temp + " °C";
  ...
  resultContainer3.append(
    day3El,
    tempForecastEl3,
    windForecastEl3,
    humidityForecastEl3
  );
  resultContainer4.append(
    day4El,
    tempForecastEl4,
    windForecastEl4,
    humidityForecastEl4
  );
  resultContainer5.append(
    day5El,
    tempForecastEl5,
    windForecastEl5,
    humidityForecastEl5
...
function searchApi(query) {
  locQueryUrl =
    ...
    "&appid=" +
    ApiKey +
    "&units=metric"; //ln 63 ifstatement js
...
function createHistoryBtn() {
  // creates & add a new button based on searchform query
  var searchInputVal = document.querySelector("#search-input").value;
...
function handleHistoryBtn() {
  // retrieves API data from localStorage based on city name of new button
